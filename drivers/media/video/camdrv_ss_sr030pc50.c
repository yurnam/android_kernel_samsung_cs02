...
static void camdrv_ss_sr030pc50_copy_files_for_60hz(void)
{
...
int camdrv_ss_sr030pc50_set_preview_start(struct v4l2_subdev *sd)
{
	...
	{
			if ( (ARRAY_SIZE(sr030pc50_fps_auto_normal_regs) != (int)NULL ) ||(ARRAY_SIZE(sr030pc50_fps_auto_Dark_regs) != (int)NULL))
				{
